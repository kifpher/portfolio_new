...
<!-- <div class="hbg">
	<div class="container grid_full hbg contact">
		<form id="contact" action="mail.php" method="post">
			...
			<input type="text" name="name" id="name" placeholder="Name:" required="required" maxlength="40" autofocus>
			<input type="email" name="email" id="email" placeholder="Email:" required="required" maxlength="50">
			<textarea name="text" id="text" placeholder="Give us a brief description of your project..." required="required" cols="80" rows="10" maxlength="10000"></textarea>
			<input type="submit" name="submit" id="sendMessage" value="Send">
